...
public partial class web_cost_sharing_mCostSharingApproval : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        WxCommon wx = new WxCommon("mSalesData",
            ...
            "1000009",
            "http://yelioa.top/web/cost_sharing/mCostSharingApproval.aspx");
        ...
        if (!string.IsNullOrEmpty(action))
        {
            ...
            {
                Response.Write(queryPendingApprovalList());
            }
    ...
    private string queryPendingApprovalList()
    {
        UserInfo userInfo = (UserInfo) Session["user"];
        return CostSharingApprovalManage.queryPendingApprovalList(userInfo);
    }
}