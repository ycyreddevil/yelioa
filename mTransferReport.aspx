<%@ Page Language="C#" AutoEventWireup="true" CodeFile="mTransferReport.aspx.cs" Inherits="mTransferReport" %>
...
<body>
    ...
    <div id="p1" class="easyui-navpanel">
        <header>
            <div class="m-toolbar">
                <span class="m-title">调拨出库报表</span>
            </div>
        </header>
...
var year = new Date().getFullYear();
    ...
    function InitMonthDatagrid() {
        $('#dg2').datagrid({
            url: 'mTransferReport.aspx',
            queryParams: {
                act: 'getMonthReport',
            ...
            */
            ...
            columns: [[
                ...
                },
                {
                    ...
                    formatter: function (value, rowData, rowIndex) {
                        var week1 = rowData.week1 == "" || rowData.week1 == null ? 0 : parseInt(rowData.week1);
                        var week2 = rowData.week2 == "" || rowData.week2 == null ? 0 : parseInt(rowData.week2);
                        var week3 = rowData.week3 == "" || rowData.week3 == null ? 0 : parseInt(rowData.week3);
                        var week4 = rowData.week4 == "" || rowData.week4 == null ? 0 : parseInt(rowData.week4);
                        var week5 = rowData.week5 == "" || rowData.week5 == null ? 0 : parseInt(rowData.week5);
    ...
    function InitDailyDatagrid() {
        $('#dg').datagrid({
            ...
            columns: [[
                ...
                { field: 'ClientName', width: 60, align: 'center', title: '收货单位', sortable: "true" },
                { field: 'HospitalName', width: 60, align: 'center', title: '医院名称', sortable: "true" },
                { field: 'Name', width: 60, align: 'center', title: '产品', sortable: "true" },
                { field: 'Specification', width: 60, align: 'center', title: '规格', sortable: "true" },
                { field: 'Unit', width: 60, align: 'center', title: '单位', sortable: "true" },
