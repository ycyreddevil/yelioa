<%@ Page Language="C#" AutoEventWireup="true" CodeFile="importCostSharing.aspx.cs" Inherits="importCostSharing" %>
...
<body class="easyui-layout">
    <div id="tb" data-options="region:'north',title:'数据导入',split:true" style="height:100px;">
        <a class="easyui-linkbutton" style="margin-top:1%" href="javascript:void(0)" data-options="iconCls:'icon-leaveStock'," onclick="OpenDialog(1)">网点明细数据导入</a> 
    </div>
    <div id="dlg-Import" class="easyui-dialog" title="网点明细数据导入" data-options="iconCls:'icon-leaveStock',modal:true,closed:true">
