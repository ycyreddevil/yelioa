            ...
            <div class="weui-search-bar" id="searchBar">
                <form class="weui-search-bar__form" onsubmit="return false;">
                    <div class="weui-search-bar__box">
                        ...
                        <a href="javascript:void(0)" class="weui-icon-clear" id="search_clear"></a>
                    </div>
                ...
                <a href="javascript:void(0)" class="weui-search-bar__cancel-btn" id="search_cancel">取消</a>
            </div>
            <div id="preview">
...
<%--                                                <li class="weui-uploader__file" style="background-image:url(./images/pic_160.png)"></li>--%>
                    ...
                    <div style="margin-bottom: 10px" id="cancelDiv">
                        <a href="javascript:void(0)" id="cancel" class="easyui-linkbutton" style="width: 100%" onclick="">撤销</a>
                    </div>
                </form>
            </div>
        </div>
        ...
        <script type="text/javascript">
            ...
            function InitDate(){
                var now = new Date();
                var month = (Array(2).join(0) + now.getMonth()).slice(-2)//数字自动补零
