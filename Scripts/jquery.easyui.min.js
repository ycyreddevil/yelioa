...
(function ($) {
    ...
    $.fn.switchbutton.defaults = {
        handleWidth: "auto", width: 60, height: 30, checked: false, disabled: false, readonly: false, reversed: false, onText: "ON", offText: "OFF", handleText: "", value: "on", label: null, labelWidth: "auto", labelPosition: "before", labelAlign: "left", onChange: function (_4f1) {
        }
    };
})(jQuery);
(function ($) {
    ...
    $.fn.radiobutton.defaults = {
        width: 20, height: 20, value: null, disabled: false, checked: false, label: null, labelWidth: "auto", labelPosition: "before", labelAlign: "left", onChange: function (_513) {
        }
    };
})(jQuery);
(function ($) {
    ...
    $.fn.checkbox.defaults = {
        width: 20, height: 20, value: null, disabled: false, checked: false, label: null, labelWidth: "auto", labelPosition: "before", labelAlign: "left", onChange: function (_536) {
        }
    };
})(jQuery);
(function ($) {
...
(function ($) {
    ...
    $.fn.passwordbox.defaults = $.extend({}, $.fn.textbox.defaults, {
        passwordChar: "%u25CF", checkInterval: 200, lastDelay: 500, revealed: false, showEye: true, inputEvents: { focus: _5d7, blur: _5db }, val: function (_5e4) {
...
(function ($) {
    ...
    function load(_646, data) {
        ...
        if (typeof data == "string") {
            ...
            $.ajax({
                url: data, data: _647, dataType: "json", success: function (data) {
                    _648(data);
                }, error: function () {
...
(function ($) {
    function _6b2(_6b3) {
        ...
        $(_6b3).addClass("spinner-f").textbox($.extend({}, opts, {
            icons: _6b5, doSize: false, onResize: function (_6b7, _6b8) {
                if (!opts.spinArrow) {
                    var span = $(this).next();
...
(function ($) {
    ...
    function _740(_741) {
        ...
        _743.panel($.extend({}, opts, {
            id: null, doSize: false, onResize: function (_744, _745) {
        ...
        if (opts.pagination) {
            ...
            _748.pagination({
                total: 0, pageNumber: opts.pageNumber, pageSize: opts.pageSize, pageList: opts.pageList, onSelectPage: function (_749, _74a) {
    ...
    function _757(_758) {
        ...
        _75d.each(function () {
            $(this).resizable({
                handles: _75e, edge: opts.resizeEdge, disabled: ($(this).attr("resizable") ? $(this).attr("resizable") == "false" : false), minWidth: 25, onStartResize: function (e) {
                    _759.resizing = true;
    ...
    var _890 = $.extend({}, _882(["text", "textbox", "passwordbox", "filebox", "numberbox", "numberspinner", "combobox", "combotree", "combogrid", "combotreegrid", "datebox", "datetimebox", "timespinner", "datetimespinner"]), {
        textarea: {
    ...
    var _8d9 = {
        render: function (_8da, _8db, _8dc) {
    ...
    $.fn.datagrid.defaults = $.extend({}, $.fn.panel.defaults, {
        sharedStyleSheet: false, frozenColumns: undefined, columns: undefined, fitColumns: false, resizeHandle: "right", resizeEdge: 5, autoRowHeight: true, toolbar: null, striped: false, method: "post", nowrap: true, idField: null, url: null, data: null, loadMsg: "Processing, please wait ...", emptyMsg: "", rownumbers: false, singleSelect: false, ctrlSelect: false, selectOnCheck: true, checkOnSelect: true, pagination: false, pagePosition: "bottom", pageNumber: 1, pageSize: 10, pageList: [10, 20, 30, 40, 50], queryParams: {}, sortName: null, sortOrder: "asc", multiSort: false, remoteSort: true, showHeader: true, showFooter: false, scrollOnSelect: true, scrollbarSize: 18, rownumberWidth: 30, editorHeight: 31, headerEvents: { mouseover: _761(true), mouseout: _761(false), click: _765, dblclick: _76a, contextmenu: _76d }, rowEvents: { mouseover: _76f(true), mouseout: _76f(false), click: _776, dblclick: _780, contextmenu: _784 }, rowStyler: function (_91f, _920) {
            ...
            $.ajax({
                type: opts.method, url: opts.url, data: _921, dataType: "json", success: function (data) {
                    _922(data);
                }, error: function () {
            ...
            getTr: function (_924, _925, type, _926) {
                type = type || "body";
                _926 = _926 || 0;
...
(function ($) {
    ...
    function _95b(_95c) {
        ...
        $(_95c).datagrid($.extend({}, opts, {
            cls: "propertygrid", view: (opts.showGroup ? opts.groupView : opts.view), onBeforeEdit: function (_95e, row) {
    ...
    var _96a = $.extend({}, $.fn.datagrid.defaults.view, {
        render: function (_96b, _96c, _96d) {
            var _96e = [];
    ...
    $.extend(_96a, {
        refreshGroupTitle: function (_9a0, _9a1) {
...
(function ($) {
    function _9c1(_9c2) {
        ...
        if (opts.pagination) {
            ...
            _9ce.pagination({
                total: 0, pageNumber: opts.pageNumber, pageSize: opts.pageSize, pageList: opts.pageList, onSelectPage: function (_9cf, _9d0) {
    ...
    var _a67 = $.extend({}, $.fn.datagrid.defaults.view, {
        render: function (_a68, _a69, _a6a) {
    ...
    $.fn.treegrid.defaults = $.extend({}, $.fn.datagrid.defaults, {
        treeField: null, checkbox: false, cascadeCheck: true, onlyLeafCheck: false, lines: false, animate: false, singleSelect: true, view: _a67, rowEvents: $.extend({}, $.fn.datagrid.defaults.rowEvents, { mouseover: _9dc(true), mouseout: _9dc(false), click: _9de }), loader: function (_aa5, _aa6, _aa7) {
            var opts = $(this).treegrid("options");
            if (!opts.url) {
                return false;
            }
            $.ajax({
                type: opts.method, url: opts.url, data: _aa5, dataType: "json", success: function (data) {
                    _aa6(data);
                }, error: function () {
            ...
            getTr: function (_aa9, id, type, _aaa) {
                type = type || "body";
                _aaa = _aaa || 0;
...
(function ($) {
    function _ab3(_ab4) {
        ...
        $(_ab4).datagrid($.extend({}, opts, {
            cls: "datalist" + (opts.lines ? " datalist-lines" : ""), frozenColumns: (opts.frozenColumns && opts.frozenColumns.length) ? opts.frozenColumns : (opts.checkbox ? [[{ field: "_ck", checkbox: true }]] : undefined), columns: (opts.columns && opts.columns.length) ? opts.columns : [[{
                field: opts.textField, width: "100%", formatter: function (_ab5, row, _ab6) {
                    return opts.textFormatter ? opts.textFormatter(_ab5, row, _ab6) : _ab5;
                }
            }]]
        }));
    };
    var _ab7 = $.extend({}, $.fn.datagrid.defaults.view, {
        render: function (_ab8, _ab9, _aba) {
    ...
    $.fn.datalist.defaults = $.extend({}, $.fn.datagrid.defaults, {
        fitColumns: true, singleSelect: true, showHeader: false, checkbox: false, lines: false, valueField: "value", textField: "text", groupField: "", view: _ab7, textFormatter: function (_ad3, row) {
            return _ad3;
...
(function ($) {
    ...
    function _ad6(_ad7) {
        ...
        $(_ad7).addClass("combo-f").textbox($.extend({}, opts, {
            icons: _add, onChange: function () {
            }
        }));
    ...
    $.fn.combo.defaults = $.extend({}, $.fn.textbox.defaults, {
        inputEvents: { click: _ae8, keydown: _aec, paste: _aec, drop: _aec, blur: _aef }, panelEvents: {
...
(function ($) {
    ...
    var _b72 = 0;
    var _b73 = {
        render: function (_b74, _b75, data) {
    ...
    $.fn.combobox.defaults = $.extend({}, $.fn.combo.defaults, {
        valueField: "value", textField: "text", groupPosition: "static", groupField: null, groupFormatter: function (_b79) {
            return _b79;
        }, mode: "local", method: "post", url: null, data: null, queryParams: {}, showItemIcon: false, limitToList: false, unselectedValues: [], mappingRows: [], view: _b73, keyHandler: {
            up: function (e) {
                nav(this, "prev");
                e.preventDefault();
            }, down: function (e) {
            ...
            mouseover: _b57, mouseout: _b58, mousedown: function (e) {
                e.preventDefault();
                e.stopPropagation();
            }, click: _b59, scroll: _b5c
            ...
            $.ajax({
                type: opts.method, url: opts.url, data: _b7d, dataType: "json", success: function (data) {
                    _b7e(data);
                }, error: function () {
...
(function ($) {
    function _bb7(_bb8) {
        ...
        var grid = _bb9.grid;
        $(_bb8).addClass("combogrid-f").combo($.extend({}, opts, {
            onShowPanel: function () {
...
(function ($) {
    function _bfb(_bfc) {
        ...
        $(_bfc).addClass("combotreegrid-f").combo($.extend({}, opts, {
            onShowPanel: function () {
        ...
        _bfd.grid.treegrid($.extend({}, opts, {
...
(function ($) {
    function _c22(_c23) {
        ...
        $(_c23).addClass("tagbox-f").combobox($.extend({}, opts, {
            cls: "tagbox", reversed: true, onChange: function (_c25, _c26) {
                _c27();
    ...
    $.fn.tagbox.defaults = $.extend({}, $.fn.combobox.defaults, {
        hasDownArrow: false, multiple: true, reversed: true, selectOnNavigation: false, tipOptions: $.extend({}, $.fn.textbox.defaults.tipOptions, { showDelay: 200 }), val: function (_c54) {
...
(function ($) {
    function _c5b(_c5c) {
        ...
        $(_c5c).addClass("datebox-f").combo($.extend({}, opts, {
            onShowPanel: function () {
                _c5e(this);
                _c5f(this);
                _c60(this);
        ...
        if (!_c5d.calendar) {
            ...
            $.extend(_c5d.calendar.calendar("options"), {
...
(function ($) {
    function _c86(_c87) {
        ...
        $(_c87).datebox("calendar").calendar({
            onSelect: function (date) {
...
(function ($) {
    ...
    function _cb9(_cba) {
        ...
        _cbc.find("a.slider-handle").draggable({
    ...
    $.fn.slider.defaults = {
        width: "auto", height: "auto", mode: "h", reversed: false, showTip: false, disabled: false, range: false, value: 0, separator: ",", min: 0, max: 100, step: 1, rule: [], tipFormatter: function (_ce2) {
            return _ce2;
        }, converter: {
            toPosition: function (_ce3, size) {
                var opts = $(this).slider("options");
