<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProductAliasManage.aspx.cs" Inherits="ProductAliasManage" %>
...
<body>
    <table id="dg" class="easyui-datagrid" title="产品信息"></table>
    <div id="dg-tb">
        <a class="easyui-linkbutton" href="javascript:void(0)" data-options="iconCls:'icon-remove'," onclick="DeleteRows();">删除</a>
        &nbsp;&nbsp;&nbsp;&nbsp;
        <a href="javascript:void(0)" class="easyui-linkbutton" iconcls="icon-leaveStock" onclick="OpenFbxDialoge();">导入产品转义信息</a>
        &nbsp;&nbsp;&nbsp;&nbsp;
        <a href="Template/产品转义导入模板.xls" >下载产品转义导入模板</a>
    </div>
    ...
    <script type="text/javascript">
        var Url = "ProductAliasManage.aspx";
        ...
        function InitDatagrid() {
            ...
            $('#dg').datagrid({
                ...
                fitColumns: true,
                columns: [[
                    { field: 'productCode', width: 5, align: 'center', title: '产品编号', sortable: "true" },
                    { field: 'name', width: 10, align: 'center', title: '产品名称' },
                    { field: 'specification', width: 10, align: 'center', title: '规格型号' },
